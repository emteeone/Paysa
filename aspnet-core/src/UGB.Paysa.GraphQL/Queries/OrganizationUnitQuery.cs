...
using UGB.Paysa.Core.Base;
using UGB.Paysa.Core.Extensions;
using UGB.Paysa.Dto;
using UGB.Paysa.Types;

namespace UGB.Paysa.Queries
{
    public class OrganizationUnitQuery : PaysaQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
