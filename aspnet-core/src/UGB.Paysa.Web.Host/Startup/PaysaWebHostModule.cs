...
using UGB.Paysa.Web.Startup.ExternalLoginInfoProviders;

namespace UGB.Paysa.Web.Startup
{
    [DependsOn(
        typeof(PaysaWebCoreModule)
    )]
    public class PaysaWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PaysaWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PaysaWebHostModule).GetAssembly());
        }
