...
using UGB.Paysa.Authentication.TwoFactor.Google;
...
namespace UGB.Paysa.Web.Controllers
{
    ...
    public class TokenAuthController : PaysaControllerBase
    {
