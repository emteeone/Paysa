...
using UGB.Paysa.Authentication.TwoFactor;
using UGB.Paysa.Chat;
using UGB.Paysa.Configuration;
using UGB.Paysa.EntityFrameworkCore;
using UGB.Paysa.Startup;
using UGB.Paysa.Web.Authentication.JwtBearer;
using UGB.Paysa.Web.Authentication.TwoFactor;
using UGB.Paysa.Web.Chat.SignalR;
using UGB.Paysa.Web.Common;
using UGB.Paysa.Web.Configuration;
using UGB.Paysa.Web.DashboardCustomization;

namespace UGB.Paysa.Web
{
    [DependsOn(
        typeof(PaysaApplicationModule),
        typeof(PaysaEntityFrameworkCoreModule),
    ...
    public class PaysaWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PaysaWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(PaysaApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PaysaWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(PaysaWebCoreModule).Assembly);
        }
