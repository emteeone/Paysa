namespace UGB.Paysa.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_TypeOperations_Delete = "Pages.TypeOperations.Delete";
        ...
        public const string Pages_Terminaux_Delete = "Pages.Terminaux.Delete";

        public const string Pages_Cartes = "Pages.Cartes";
        public const string Pages_Cartes_Create = "Pages.Cartes.Create";
        public const string Pages_Cartes_Edit = "Pages.Cartes.Edit";
        public const string Pages_Cartes_Delete = "Pages.Cartes.Delete";

        public const string Pages_Comptes = "Pages.Comptes";
        ...
        public const string Pages_Etudiants_Edit = "Pages.Etudiants.Edit";
        public const string Pages_Etudiants_Delete = "Pages.Etudiants.Delete";

        public const string Pages_Chambres = "Pages.Chambres";
        public const string Pages_Chambres_Create = "Pages.Chambres.Create";
        public const string Pages_Chambres_Edit = "Pages.Chambres.Edit";
        public const string Pages_Chambres_Delete = "Pages.Chambres.Delete";
