...
namespace UGB.Paysa.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PaysaServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("UGB.Paysa", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
