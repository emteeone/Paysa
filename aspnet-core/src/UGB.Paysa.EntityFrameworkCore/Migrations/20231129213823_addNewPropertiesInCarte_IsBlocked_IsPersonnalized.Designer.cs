...
namespace UGB.Paysa.Migrations
{
    ...
    [Migration("20231129213823_addNewPropertiesInCarte_IsBlocked_IsPersonnalized")]
    partial class addNewPropertiesInCarte_IsBlocked_IsPersonnalized
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UGB.Paysa.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("UGB.Paysa.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("UGB.Paysa.UGB.Paysa.Chambres.PaiementLoyer", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("UgbPaiementLoyer");
                });

            modelBuilder.Entity("UGB.Paysa.Wallet.Chambres.Chambre", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<double>("MontantLocation")
                        .HasColumnType("float");
                    ...
                    b.ToTable("UgbChambre");
                });

            modelBuilder.Entity("UGB.Paysa.Wallet.Comptes.Compte", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UGB.Paysa.Wallet.Etudiants.Etudiant", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<int>("SituationMatrimoniale")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UGB.Paysa.Wallet.Operations.TypeOperation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UGB.Paysa.Wallet.Tools.Carte", b =>
                {
                    ...
                    b.Property<bool>("IsPersonnalized")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("UGB.Paysa.Wallet.Tools.Terminal", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UGB.Paysa.Wallet.Operations.Credit", b =>
                {
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("UGB.Paysa.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("UGB.Paysa.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("UGB.Paysa.UGB.Paysa.Chambres.PaiementLoyer", b =>
                {
                    b.HasOne("UGB.Paysa.Wallet.Chambres.Chambre", "ChambreFk")
                        .WithMany()
                        .HasForeignKey("ChambreId");

                    b.HasOne("UGB.Paysa.Wallet.Operations.Operation", "OperationFk")
                        .WithMany()
                        .HasForeignKey("OperationId");

                    b.Navigation("ChambreFk");

                    b.Navigation("OperationFk");
                });

            modelBuilder.Entity("UGB.Paysa.Wallet.Comptes.Compte", b =>
                {
                    b.HasOne("UGB.Paysa.Wallet.Etudiants.Etudiant", "EtudiantFk")
                        .WithMany()
                        .HasForeignKey("EtudiantId");

                    b.Navigation("EtudiantFk");
                });
