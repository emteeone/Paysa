...
{
    public class SubscriptionPaymentRepository : PaysaRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<PaysaDbContext> dbContextProvider)
