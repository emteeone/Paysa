...
using UGB.Paysa.EntityFrameworkCore.Repositories;

namespace UGB.Paysa.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : PaysaRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<PaysaDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
