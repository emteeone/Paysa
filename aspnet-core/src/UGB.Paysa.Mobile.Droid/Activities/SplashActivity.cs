...
namespace UGB.Paysa.Activities
{
    ...
    public class SplashActivity : AppCompatActivity
    {
        ...
        {
            base.OnResume();
            ApplicationBootstrapper.InitializeIfNeeds<PaysaXamarinAndroidModule>();
        ...
        private async Task StartApplication()
        {
           ...
           */
            DebugServerIpAddresses.Current = "192.168.1.125"; // "10.0.2.2";
