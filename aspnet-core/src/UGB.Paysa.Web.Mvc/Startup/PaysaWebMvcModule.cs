...
namespace UGB.Paysa.Web.Startup
{
    ...
    public class PaysaWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PaysaWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PaysaWebMvcModule).GetAssembly());
        }
