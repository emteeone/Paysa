...
namespace UGB.Paysa.Web.Public.Startup
{
    ...
    public class PaysaWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PaysaWebFrontEndModule(IWebHostEnvironment env, PaysaEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PaysaWebFrontEndModule).GetAssembly());
        }
    }
}
