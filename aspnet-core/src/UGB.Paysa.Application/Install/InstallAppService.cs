...
namespace UGB.Paysa.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PaysaAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PaysaDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{PaysaConsts.ConnectionStringName}", constring);
        }
