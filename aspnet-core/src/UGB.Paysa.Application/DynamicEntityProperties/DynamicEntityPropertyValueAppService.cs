...
using UGB.Paysa.DynamicEntityPropertyValues.Dto;

namespace UGB.Paysa.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : PaysaAppServiceBase, IDynamicEntityPropertyValueAppService
    {
