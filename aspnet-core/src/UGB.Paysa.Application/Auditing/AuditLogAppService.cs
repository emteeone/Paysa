...
using UGB.Paysa.Auditing.Exporting;
using UGB.Paysa.Authorization;
using UGB.Paysa.Authorization.Users;
using UGB.Paysa.Dto;
using UGB.Paysa.EntityHistory;
using EntityHistoryHelper = UGB.Paysa.EntityHistory.EntityHistoryHelper;

namespace UGB.Paysa.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : PaysaAppServiceBase, IAuditLogAppService
    {
