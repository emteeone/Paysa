...
{
    public class SessionAppService : PaysaAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = PaysaConsts.Currency,
                        CurrencySign = PaysaConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = PaysaConsts.AllowTenantsToChangeEmailSettings,
