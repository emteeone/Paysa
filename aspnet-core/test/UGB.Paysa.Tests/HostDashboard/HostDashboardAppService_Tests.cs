...
using UGB.Paysa.MultiTenancy.HostDashboard;
...
namespace UGB.Paysa.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(PaysaDbContext context, SubscriptionPayment subscriptionPayment)
        {
